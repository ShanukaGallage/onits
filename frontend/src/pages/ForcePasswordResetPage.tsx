...
export default function ForcePasswordResetPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-6 relative overflow-hidden font-jakarta">
      {/* Ambient blobs */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/8 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent/6 rounded-full blur-[100px] pointer-events-none" />

      {/* Card */}
      <div className="w-full max-w-[440px] bg-card rounded-xl border border-border shadow-[0_4px_24px_rgba(70,72,212,0.08)] relative z-10 overflow-hidden">

        {/* Top accent bar */}
        <div className="h-1 bg-gradient-to-r from-primary via-ip-primary-container to-ip-tertiary" />

        <div className="p-8">
          {/* Branding */}
          <div className="flex flex-col items-center mb-8 text-center">
            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center mb-4 shadow-[0_4px_12px_rgba(70,72,212,0.3)]">
            ...
            <p className="text-[13px] text-muted-foreground mt-1.5 leading-snug max-w-[280px]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label
                ...
                className="block text-[11px] font-semibold uppercase tracking-widest text-foreground"
              >
                Temporary Password
              </label>
          ...
          {/* Footer */}
          <p className="text-[11px] font-medium text-muted-foreground text-center mt-6">
